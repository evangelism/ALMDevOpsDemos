    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mClient = new MobileServiceClient(
                    ...
                    "HkQEGAKtRwJUwvBhsiuygqjcknWsvh75",
...
//TODO: track an event
            client.trackEvent("sample event from alm");

//TODO: track a metric
            client.trackMetric("sample metric from alm", 3);
            EngagementConfiguration engagementConfiguration = new EngagementConfiguration();
            engagementConfiguration.setConnectionString("Endpoint=MobileDemo-Collection.device.mobileengagement.windows.net;SdkKey=;AppId=cum000061");
